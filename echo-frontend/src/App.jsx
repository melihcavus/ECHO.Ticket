...
function App() {
    ...
    const handleLogin = async (e) => {
        ...
        setLoading(true);
        try {
            // NOT: Buradaki URL senin .NET API adresinle aynı olmalı (Örn: 5216)
            const response = await axios.post('http://localhost:5216/api/Users/login', {
                email: email,
                password: password
            });
                ...
                <div className="md:w-2/5 p-5">
                    <div className="bg-white h-full rounded-[1.5rem] p-10 flex flex-col justify-center shadow-inner relative overflow-hidden">
                        ...
                        <p className="text-center text-base text-slate-600 mt-10">
                            Don't have an account? <a href="#" className="text-cyan-600 font-bold hover:underline">Sign up.</a>
                        </p>
